...
<form action="${pageContext.request.contextPath}/saveForecast" method="post">
    ...
    <p>Команды: ${requestScope.match.firstTeamId}  <input id="firstTeamResult" name="firstTeamResult"> - <input id="secondTeamResult" name="secondTeamResult"> ${requestScope.match.secondTeamId}</p>
